...
Shared public data: [Google Drive directory](https://drive.google.com/drive/u/1/folders/1Z22QCs1fTQTDYhM-qOqR1jrg5Zc0D6Hc)
...
All training and evaluation samples used in the paper are provided pregenerated in their corresponding directory inside `datasets/`. The set of pregenerated training samples used for training in the paper can be downloaded from a [Google Drive directory](https://drive.google.com/drive/u/1/folders/1Z22QCs1fTQTDYhM-qOqR1jrg5Zc0D6Hc) (`datasets/training_samples_pregen.tar`).
...
You can try out a trained model on new road scenes generated by yourself. The same pretrained model used for evaluation and visualization in the paper can be downloaded from a [Google Drive directory](https://drive.google.com/drive/u/1/folders/1Z22QCs1fTQTDYhM-qOqR1jrg5Zc0D6Hc) (`pretrained_models/checkpoint_70000.tar`).
